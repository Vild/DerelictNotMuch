module derelict.notmuch.statfun;
...
notmuch_status_t notmuch_database_open_verbose(const(char)* path, notmuch_database_mode_t mode,
 ...
 */
notmuch_status_t notmuch_database_compact(const(char)* path, const(char)* backup_path,
 ...
 */
notmuch_status_t notmuch_database_upgrade(notmuch_database_t* database, void function(void* closure,
		double progress) progress_notify, void* closure);
 ...
 * 	database to use this function.
 */
notmuch_status_t notmuch_database_find_message_by_filename(notmuch_database_t* notmuch, const(char)* filename,
 ...
 *
 */
deprecated("function deprecated as of libnotmuch 4.3") notmuch_threads_t* notmuch_query_search_threads(notmuch_query_t* query);
 ...
 *
 */
deprecated("function deprecated as of libnotmuch 4.3") notmuch_messages_t* notmuch_query_search_messages(notmuch_query_t* query);
 ...
 */
deprecated("function deprecated as of libnotmuch 4.3") uint notmuch_query_count_messages(notmuch_query_t* query);
 ...
 */
deprecated("function deprecated as of libnotmuch 4.3") uint notmuch_query_count_threads(notmuch_query_t* query);
